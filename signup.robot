...
Deve poder cadastrar um novo dog walker
   ...
   ${name}             Set Variable  Amandatec Oliveira
   ${email}            Set Variable  amandatec@email.com
  ...
  Go to signup page
  Fill signup form  ${name}   ${email}    ${cpf}   ${cep}  ${addressStreet}  ${addressCityUf}  ${addressDistrict}  ${addressNumber}   ${addressDetails}  ${cnh} 
  Submit signup form
...
Fill signup form
   [Arguments]  ${name}   ${email}    ${cpf}   ${cep}  ${addressStreet}  ${addressCityUf}  ${addressDistrict}  ${addressNumber}   ${addressDetails}  ${cnh} 
